  ...
  describe("TransactionExtractionSchema", () => {
    it("should validate a complete dividend extraction", () => {
      const data = {
        ...
        transactions: [{
          transactionType: "dividend" as const,
          confidence: 0.95,
    ...
    it("should validate a stock trade extraction", () => {
      const data = {
        ...
        emailType: "transactional" as const,
        transactions: [{
          transactionType: "stock_trade" as const,
          confidence: 0.92,
          transactionDate: "2024-01-15",
          amount: 18550,
          currency: "USD",
    ...
    it("should validate an option trade extraction", () => {
      const data = {
        ...
        emailType: "transactional" as const,
        transactions: [{
          transactionType: "option_trade" as const,
          confidence: 0.88,
          transactionDate: "2024-01-15",
          amount: 550,
          currency: "USD",
    ...
    it("should validate a wire transfer extraction", () => {
      const data = {
        ...
        emailType: "transactional" as const,
        transactions: [{
          transactionType: "wire_transfer_out" as const,
          confidence: 0.98,
          transactionDate: "2024-01-15",
          amount: 50000,
          currency: "USD",
      ...
      it.each(validTypes)("should accept transaction type: %s", (type) => {
        const data = {
          ...
          transactions: [{
            ...
            confidence: 0.8,
            transactionDate: "2024-01-15",
            // Include all optional/nullable fields
            amount: null,
            accountNumber: null,
            accountName: null,
            institution: null,
