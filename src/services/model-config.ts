...
export const AVAILABLE_MODELS: ModelConfig[] = [
  ...
  },
  {
    ...
    description: "Latest fast model. Same performance as Sonnet 4 at lower cost.",
  ...
  // OpenAI Models
  {
    ...
    provider: "openai",
    name: "GPT-4o",
    description: "OpenAI's flagship model. Excellent for data extraction tasks.",
  ...
  },
  {
    ...
    provider: "openai",
    name: "GPT-4o Mini",
    description: "Fast and affordable. Great for high-volume processing.",
